...
using UdemyCarBook.Application.Features.Mediator.Results.CarFeatureResuts;
...
{
    public class GetCarFeatureByIdQueryHandler : IRequestHandler<GetCarFeatureByCarIdQuery, List<GetCarFeatureByCarIdQueryResult>>
    {
