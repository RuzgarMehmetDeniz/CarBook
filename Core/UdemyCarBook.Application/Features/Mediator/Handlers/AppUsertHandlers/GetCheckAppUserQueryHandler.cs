...
namespace UdemyCarBook.Application.Features.Mediator.Handlers.AppUsertHandlers
{
   
    public class GetCheckAppUserQueryHandler : IRequestHandler<GetChechkAppUserQuery, GetCheckAppUserQueryResult>
    {
        ...
        public async Task<GetCheckAppUserQueryResult> Handle(GetChechkAppUserQuery request, CancellationToken cancellationToken)
        {
