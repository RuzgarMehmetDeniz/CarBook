...
{
    public class CreatePricingCommandQueryHandler : IRequestHandler<CreatePricingCommand>
    {
        private readonly IRepository<Pricing> _repository;

        public CreatePricingCommandQueryHandler(IRepository<Pricing> repository)
        {
