...
{
    public class UpdatePricingCommandQueryHandler : IRequestHandler<UpdatePricingCommand>
    {
        private readonly IRepository<Pricing> _repository;

        public UpdatePricingCommandQueryHandler(IRepository<Pricing> repository)
        {
